...
@traceable(
    name="self_healing_detect", tags=["workflow", "self-healing", "infrastructure"]
)
...
@traceable(
    name="self_healing_diagnose", tags=["workflow", "self-healing", "multi-agent"]
)
...
@traceable(
    name="self_healing_apply_fix", tags=["workflow", "self-healing", "remediation"]
)
...
@traceable(name="self_healing_verify", tags=["workflow", "self-healing", "validation"])
...
workflow.add_conditional_edges(
    "verify", check_resolution, {END: END, "detect": "detect"}
)
