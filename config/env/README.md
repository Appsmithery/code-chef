...
- **LangSmith tracing** (`LANGSMITH_API_KEY`, `LANGCHAIN_API_KEY`, `LANGCHAIN_PROJECT`)
- **Gradient credentials** (`GRADIENT_API_KEY`, `GRADIENT_MODEL_ACCESS_KEY`)
- **Linear integration** (`LINEAR_API_KEY`, template UUIDs)
- **DigitalOcean** (`DIGITAL_OCEAN_PAT`)
