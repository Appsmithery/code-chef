        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              {totalTools}+ tools across {mcpServers.length} MCP servers.
              Progressive loading keeps costs down while maintaining full
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                Instead of loading all {totalTools}+ tools for every request,
                agents use a{" "}
                <span className="text-accent font-medium">
                  three-tier strategy
                </span>{" "}
                that balances capability with token efficiency:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
                <Card className="bg-card border-accent/20">
                  ...
                  <CardContent className="text-sm">
                    Core tools matched by keywords. Used for simple,
                    well-defined tasks.
                  </CardContent>
                </Card>
                <Card className="bg-card border-accent/20">
                  ...
                  <CardContent className="text-sm">
                    Agent-priority tools plus keyword matches. Balances cost and
                    capability.
                  </CardContent>
                </Card>
                <Card className="bg-card border-accent/20">
                  ...
                  <CardContent className="text-sm">
                    All available tools. Reserved for complex debugging and
                    discovery.
                  </CardContent>
                </Card>
              </div>
              <p>
                This approach reduces token costs by{" "}
                <span className="text-accent font-medium">80-90%</span> on
                typical workflows while maintaining full access when agents need
                it. Tools are bound at invoke-time, not initialization, allowing
                dynamic strategy selection per request.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 border-t border-border">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              All MCP servers are configured via{" "}
              <code className="px-2 py-1 rounded bg-muted text-accent font-mono text-sm">
                config/mcp-agent-tool-mapping.yaml
              </code>{" "}
              with environment-based authentication. Agents automatically
              discover available tools through the ProgressiveMCPLoader without
