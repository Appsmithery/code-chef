    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground font-sans selection:bg-accent selection:text-accent-foreground">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center">
            <img src="/logos/banner_logo_transparent.svg" alt="code/chef logo" className="h-10 w-auto" />
          </div>
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            <a href="#" className="text-accent transition-colors hover:text-accent/80">Home</a>
            <a href="#agents" className="text-foreground transition-colors hover:text-accent">Agents</a>
            <a href="#servers" className="text-foreground transition-colors hover:text-accent">Servers</a>
            <a href="#cookbook" className="text-foreground transition-colors hover:text-accent">Cookbook</a>
          </nav>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight">
                    ...
                    <span className="text-muted-foreground text-2xl md:text-3xl font-normal">for the modern kitchen.</span>
                  </h1>
                  <p className="text-lg text-muted-foreground max-w-[600px] leading-relaxed">
                    Orchestrate your infrastructure with AI agents. From code generation to deployment, let the Chef handle the heat.
                  </p>
                </div>

                <div className="flex flex-wrap gap-4">
                  <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 h-12 px-8 font-medium">
                    <Bot className="mr-2 h-5 w-5" />
                    Meet the Team
                  </Button>
                  <Button size="lg" variant="outline" className="border-accent/30 text-accent hover:bg-accent hover:text-accent-foreground h-12 px-8 font-medium">
              ...
              <div className="relative hidden lg:block">
                ...
                <div className="relative bg-card border border-border rounded-xl overflow-hidden shadow-lg">
                  <div className="flex items-center px-4 py-3 border-b border-border bg-muted">
                    ...
                    <div className="ml-4 text-xs font-medium text-muted-foreground">chef-orchestrator — zsh — 80x24</div>
                  </div>
        ...
        <section className="py-24 bg-background relative">
          <div className="container">
            <div className="flex flex-col items-center text-center mb-16 space-y-4">
              <Badge variant="outline" className="border-accent/30 text-accent bg-accent/5">Capabilities</Badge>
              <h2 className="text-4xl md:text-5xl font-bold tracking-tight">What's Cookin'?</h2>
              <p className="text-muted-foreground max-w-[700px]">
                A complete menu of DevOps automation tools, served hot and ready for production.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
              ...
              <Card className="md:col-span-2 bg-card border-border hover:border-accent/50 transition-all duration-300 group">
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    Qdrant Cloud with 1,200+ vectors across code patterns, Linear issues, and documentation for contextual assistance.
                  </CardDescription>
                </CardHeader>
                <CardContent className="flex gap-2 flex-wrap">
                  <Badge variant="secondary" className="bg-secondary/10 text-secondary hover:bg-secondary/20 border-none">Code Patterns</Badge>
                  <Badge variant="secondary" className="bg-secondary/10 text-secondary hover:bg-secondary/20 border-none">Linear Issues</Badge>
                  <Badge variant="secondary" className="bg-secondary/10 text-secondary hover:bg-secondary/20 border-none">Documentation</Badge>
                </CardContent>
              </Card>
              ...
              <Card className="bg-card border-border hover:border-accent/50 transition-all duration-300 group">
                ...
                <CardContent>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Running on DigitalOcean with Caddy reverse proxy, automatic HTTPS, and optimized for 2GB memory footprint.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="py-24 border-t border-border bg-muted/30">
          <div className="container">
            <div className="flex flex-col items-center text-center mb-12">
              <h2 className="text-4xl font-bold tracking-tight mb-4">Quick Links</h2>
              <p className="text-muted-foreground">Direct access to the kitchen's vital systems.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <a href="https://codechef.appsmithery.co/api/health" target="_blank" rel="noreferrer" className="group">
                <Card className="h-full bg-card border-border hover:border-accent transition-all duration-300 hover:shadow-md">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-lg font-medium">Orchestrator API</CardTitle>
                    <Badge className="bg-primary/20 text-primary hover:bg-primary/30 border-none">Live</Badge>
                  </CardHeader>
                  <CardContent>
                    <div className="text-2xl font-bold text-muted-foreground group-hover:text-foreground transition-colors">:8001</div>
              ...
              <a href="https://smith.langchain.com" target="_blank" rel="noreferrer" className="group">
                <Card className="h-full bg-card border-border hover:border-secondary transition-all duration-300 hover:shadow-md">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-lg font-medium">LangSmith</CardTitle>
                    <Badge className="bg-secondary/20 text-secondary hover:bg-secondary/30 border-none">Connected</Badge>
                  </CardHeader>
                  <CardContent>
                    <div className="text-2xl font-bold text-muted-foreground group-hover:text-foreground transition-colors">Tracing</div>
                    <p className="text-xs text-muted-foreground mt-2">
              ...
              <a href="https://appsmithery.grafana.net/a/grafana-lokiexplore-app/explore" target="_blank" rel="noreferrer" className="group">
                <Card className="h-full bg-card border-border hover:border-primary transition-all duration-300 hover:shadow-md">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-lg font-medium">Grafana Cloud</CardTitle>
                    <Badge className="bg-primary/20 text-primary hover:bg-primary/30 border-none">Metrics</Badge>
                  </CardHeader>
                  <CardContent>
                    <div className="text-2xl font-bold text-muted-foreground group-hover:text-foreground transition-colors">Monitoring</div>
                    <p className="text-xs text-muted-foreground mt-2">
      ...
      <footer className="border-t border-border bg-background py-12">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <span className="text-sm text-muted-foreground">© 2025 code/chef — "Yes, Chef!"</span>
          </div>
          
          <div className="flex items-center gap-6 text-sm text-muted-foreground">
            <a href="#" className="hover:text-accent transition-colors">Documentation</a>
            <span className="text-border">|</span>
            <a href="https://github.com/Appsmithery/code-chef" target="_blank" rel="noreferrer" className="hover:text-accent transition-colors flex items-center gap-2">
