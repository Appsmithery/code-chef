...
async def main():
    ...
    parser.add_argument("--embeddings-only", action="store_true", help="Test embeddings only")
    ...
    if not args.llm_only:
        success = await test_embeddings(EMBEDDING_PROVIDER if not args.provider else provider) and success
